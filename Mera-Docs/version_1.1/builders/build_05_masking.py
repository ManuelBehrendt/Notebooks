#!/usr/bin/env python3
"""Build 05_multi_Masking_Filtering.ipynb (and a pre-flight .jl of its code cells)."""
import json, sys, os

OUT_NB = "/Volumes/FASTStorage/Simulations/Mera-Docs/version_1.1/05_multi_Masking_Filtering.ipynb"
OUT_JL = os.path.join(os.path.dirname(os.path.abspath(__file__)), "preflight_masking.jl")
...
def preflight():
    parts = ["# AUTO-GENERATED pre-flight for 05_masking.\n__t0 = time()\n"]
