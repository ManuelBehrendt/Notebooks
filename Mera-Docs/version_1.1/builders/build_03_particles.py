#!/usr/bin/env python3
"""Build 03_particles_Get_Subregions.ipynb (and a pre-flight .jl of its code cells)."""
import json, sys, os

OUT_NB = "/Volumes/FASTStorage/Simulations/Mera-Docs/version_1.1/03_particles_Get_Subregions.ipynb"
OUT_JL = os.path.join(os.path.dirname(os.path.abspath(__file__)), "preflight_particles.jl")

CELLS = []
md = lambda t: CELLS.append(("markdown", t.strip("\n") + "\n"))
...
def preflight():
    parts = ["# AUTO-GENERATED pre-flight for 03_particles.\n__t0 = time()\n"]
